  ...
  const onSubmit = React.useCallback(
    async (values) => {
      try {
        ...
        const { error, user } = await authClient.signInWithPassword(values, dispatch);
        ...
        setError("root", { type: "server", message: "Une erreur inattendue est survenue." });
      } finally {
        setIsPending(false);
      }
    },
    [checkSession, dispatch, setError,setIsPending]
  );
